...
is_lts: false
intro: |
  This page describes the Rocq Platform version **2025.08.1**, released on
  Fev 9th, 2026. Go [here](/releases) for a list of all Coq, Rocq and Platform releases.
...
- [Windows (64 bit) installer for Rocq 9.0](https://github.com/rocq-prover/platform/releases/download/2025.08.1/signed_Rocq-Platform-release-2025.08.1-version.9.0.2025.08-Windows-x86_64.exe)
- [MacOS (arm) installer for Rocq 9.0](https://github.com/rocq-prover/platform/releases/download/2025.08.1/signed_Rocq-Platform-release-2025.08.2.dmg)

**Note**: snap is no longer supported (we are working on a replacement)

### General information

See [README](https://github.com/rocq-prover/platform/blob/2025.08.1/README.md) for general information and installation of Rocq Platform.

See [Charter](https://github.com/rocq-prover/platform/blob/2025.08.1/charter.md) for the concept and goals of Rocq Platform.
...
See [macOS](https://github.com/rocq-prover/platform/blob/2025.08.1/doc/README_macOS.md), [Linux](https://github.com/rocq-prover/platform/blob/2025.08.1/doc/README_Linux.md) and [Windows](https://github.com/rocq-prover/platform/blob/2025.08.1/doc/README_Windows.md) for detailed installation and usage instructions.
...
- **Rocq 9.0.1** with the first [package collection](https://github.com/rocq-prover/platform/blob/2025.08.1/doc/README~9.0.1~2025.08.md) from August 2025
